...
#%%
columns = ['split', 'test overall_acc','test overall_acc sup', 'test mIOU','test mIOU sup', 'test mDICE', 'test mDICE sup'	]
...
fig, ax = plt.subplots()
for col in columns:
    metrics_df[col].reset_index().plot('split', 'mean', yerr='std',
               label=col[5:], ax=ax)
# %%
